...
I will be creating a user friendly form with client side validation using HTML and CSS. It will be accessible for those who use screen readers.

Demonstrate the use of pseudo selectors.
